package punk
{
   ...
   public class Backdrop extends Entity
   {
      ...
      override public function render() : void
      {
         ...
         if(this._repeatX)
         {
            this._point.x = (x - FP.camera.x * this._scrollX) % this._scrollW;
            if(this._point.x > 0)
            {
         ...
         {
            this._point.x = x - FP.camera.x * this._scrollX;
         }
         if(this._repeatY)
         {
            this._point.y = (y - FP.camera.y * this._scrollY) % this._scrollH;
            if(this._point.y > 0)
            {
         ...
         {
            this._point.y = y - FP.camera.y * this._scrollY;
         }
