package punk.logo
{
   ...
   public class LogoText extends Acrobat
   {
      ...
      private const SndScribble:Class = Library.LogoText_SndScribble;

      private const SndBoing:Class = Library.LogoText_SndBoing;
      ...
      private const ImgLogoText:Class = Library.LogoText_ImgLogoText;
